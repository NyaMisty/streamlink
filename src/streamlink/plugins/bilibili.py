    ...
    def update_playlist(self):
        ...
        for stream_list in urls:
            ...
            if 'd1--cn-gotcha01.bilivideo.com' in _url:
                newurl = _url.replace("d1--cn-gotcha01.bilivideo.com/", "7s6dgkcy7btyx.cfc-execute.bj.baidubce.com/101/")
            ...
            if "d1--cn-gotcha104.bilivideo.com" in url:
                url = url.replace("d1--cn-gotcha104.bilivideo.com/", "7s6dgkcy7btyx.cfc-execute.bj.baidubce.com/104/")
